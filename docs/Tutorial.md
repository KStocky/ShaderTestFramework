...
2. Visual Studio 2022 17.7 - This is due to the project making use of several C++23 features e.g. [std::views::enumerate](https://en.cppreference.com/cpp/ranges/enumerate_view)
