...
The TTL (Test Template Library) provides a number of type traits in the [`type_traits.hlsli`](../../../src/Shader/TTL/type_traits.hlsli) header. These operate in the same way as [C++ type traits](https://en.cppreference.com/cpp/header/type_traits).
...
| | |
|-|-|
| [`always_false`](./AlwaysFalse.md) | Instantiation of this template will always provide a `value` of `false` |
