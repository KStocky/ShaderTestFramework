...
function(nuget_get_dxc IN_TARGET OUT_SUCCEEDED OUT_INCLUDE_PATH OUT_BINARY_PATH OUT_LIB_PATH)
    ...
    nuget_pkg_get(${IN_TARGET} "Microsoft.Direct3D.DXC" "1.8.2505.32" ${OUT_SUCCEEDED} PKG_PATH)
...
function(nuget_get_warp IN_TARGET OUT_SUCCEEDED OUT_BINARY_PATH)
    ...
    nuget_pkg_get(${IN_TARGET} "Microsoft.Direct3D.WARP" "1.0.16.1" ${OUT_SUCCEEDED} PKG_PATH)
